...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 15, vars: 1, consts: [["color", "primary"], [1, "spacer"], ["mat-button", "", 3, "click"], [1, "container"], [4, "ngFor", "ngForOf"], ["matListAvatar", "", "src", "assets/man.png", "alt", "..."], ["matLine", ""], ["mat-icon-button", "", 3, "matMenuTriggerFor"], ["menu", "matMenu"], ["mat-menu-item", "", 3, "click"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
